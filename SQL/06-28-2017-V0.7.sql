...
INSERT INTO `models` VALUES (1,'model1','IDK type of format file describing the trained model','model1 path','model1 project_id','model1 experiment_id'),(2,'model2','IDK type of format file describing the trained model','model2 path','model2 project_id','model2 experiment_id');
...
INSERT INTO `predictions` VALUES (1,'prediction1','XML/YAML/ARFF file with instance-level predictions generated by the model','prediction1 path','prediction1 project_id','prediction1 experiment_id'),(2,'prediction2','XML/YAML/ARFF file with instance-level predictions generated by the model','prediction2 path','prediction2 project_id','prediction2 experiment_id');
